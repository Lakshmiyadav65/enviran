                ...
                <article className={styles.article}>
                    ...
                    <section id="next-steps" className={styles.section}>
                        ...
                        <div className={styles.nextGrid}>
                            <button className={styles.nextCard} onClick={() => navigate('/knowledge-base/manuals-pcf')}>
                    ...
                    <div className={styles.articleFooterNav}>
                        <button className={styles.footerNavBtn} onClick={() => navigate('/knowledge-base/manuals-pcf')}>
                            <svg width="14" height="14" viewBox="0 0 24 24" fill="none">
                                <path d="M19 12H5M5 12l7 7M5 12l7-7" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                            </svg>
                            Back to Manuals
                        </button>
                        <button className={styles.footerNavBtnNext} onClick={() => navigate('/knowledge-base/manuals-pcf')}>
