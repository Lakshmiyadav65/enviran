            ...
            <div className={styles.layout}>
                ...
                <article className={styles.article}>
                    ...
                    <div className={styles.articleFooterNav}>
                        <button className={styles.footerNavBtn} onClick={() => navigate('/knowledge-base/article-what-is-enviguide')}>
                            <svg width="14" height="14" viewBox="0 0 24 24" fill="none">
                                <path d="M19 12H5M5 12l7 7M5 12l7-7" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                            </svg>
                            What is Enviguide?
                        </button>
                        <button className={styles.footerNavBtnNext} onClick={() => navigate('/knowledge-base/supplier-questionnaire')}>
