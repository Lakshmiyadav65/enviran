        ...
        <aside className={styles.sidebar}>
            ...
            <div className={styles.knowledgeCard}>
                ...
                <div className={styles.knowledgeContent}>
                    ...
                    <button className={styles.knowledgeLink} onClick={() => navigate('/knowledge-base/help-centre')}>Browse Guides →</button>
                </div>
            </div>

            {/* Help & Support */}
            <button className={styles.helpBtn} onClick={() => navigate('/knowledge-base/support')}>
