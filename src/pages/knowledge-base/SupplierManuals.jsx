        ...
        <div className={styles.page}>
            ...
            <main className={styles.container}>
                ...
                <div className={styles.grid}>
                    {/* Card 1: Access */}
                    <div className={styles.card} onClick={() => navigate('/knowledge-base/article-supplier-access')}>
                    ...
                    {/* Card 2: Guidance */}
                    <div className={styles.card} onClick={() => navigate('/knowledge-base/supplier-questionnaire')}>
                        <div className={styles.iconBox} style={{ background: '#ecfdf5', color: '#22c55e' }}>
                            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
