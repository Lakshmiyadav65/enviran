                ...
                <div className={styles.categoryGrid}>
                    {CATEGORIES.map((cat) => (
                        <div
                            ...
                            onClick={() => {
                                if (cat.id === 'supplier') navigate('/knowledge-base/supplier-questionnaire')
                                if (cat.id === 'manufacturer') navigate('/knowledge-base/manufacturer-questionnaire')
                                if (cat.id === 'env') navigate('/knowledge-base/article-what-is-enviguide')
                                if (cat.id === 'pcf') navigate('/knowledge-base/manuals-pcf')
                            }}
                        ...
                        {!showRoles ? (
                            ...
                            <div className={styles.roleSelection}>
                                ...
                                <div className={styles.roleGrid}>
                                    <button className={styles.roleOption} onClick={() => navigate('/knowledge-base/support')}>
                ...
                <div className={styles.bottomGrid}>
                    ...
                    <div>
                        ...
                        <div className={styles.featuredCard}>
                            ...
                            <button className={styles.readNowBtn} onClick={() => navigate('/knowledge-base/manuals-pcf')}>Explore Manuals</button>
                        </div>
