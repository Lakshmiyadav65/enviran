    ...
    return (
        <div className={styles.page}>
            ...
            <div className={styles.topBar}>
                <button className={styles.backBtn} onClick={() => navigate('/knowledge-base/help-centre')}>
            ...
            <div className={styles.layout}>
                ...
                <article className={styles.article}>
                            ...
                            {[
                                {
                                    ...
                                    path: '/knowledge-base/article-platform-walkthrough',
                                    color: '#22c55e',
                                },
                                {
                                    tag: 'POPULAR',
                                    ...
                                    path: '/knowledge-base/supplier-questionnaire',
                                    color: '#3b82f6',
                                },
                                {
                                    tag: 'TUTORIAL',
                    ...
                    <div className={styles.articleFooterNav}>
                        <button className={styles.footerNavBtn} onClick={() => navigate('/knowledge-base/help-centre')}>
                            <svg width="14" height="14" viewBox="0 0 24 24" fill="none">
                                <path d="M19 12H5M5 12l7 7M5 12l7-7" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                            </svg>
                            Back to Help Center
                        </button>
                        <button className={styles.footerNavBtnNext} onClick={() => navigate('/knowledge-base/article-platform-walkthrough')}>
