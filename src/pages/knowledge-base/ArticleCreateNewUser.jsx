    ...
    return (
        <div className={styles.page}>
            ...
            <div className={styles.topBar}>
                <button className={styles.backBtn} onClick={() => navigate('/knowledge-base/manuals-admin')}>
            ...
            <div className={styles.layout}>
                ...
                <article className={styles.article}>
                    ...
                    <div className={styles.breadcrumb}>
                        <button className={styles.breadLink} onClick={() => navigate('/knowledge-base/help-centre')}>Help Center</button>
                        <svg width="12" height="12" viewBox="0 0 24 24" fill="none">
                            <path d="M9 18l6-6-6-6" stroke="#9ca3af" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                        </svg>
                        <button className={styles.breadLink} onClick={() => navigate('/knowledge-base/manuals-admin')}>Admin Manuals</button>
                        <svg width="12" height="12" viewBox="0 0 24 24" fill="none">
                            <path d="M9 18l6-6-6-6" stroke="#9ca3af" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                        </svg>
                        ...
                        <div className={styles.calloutBlue}>
                            ...
                            <div>
                                ...
                                <p className={styles.calloutText}>
                                    ...
                                    <button
                                        onClick={() => navigate('/knowledge-base/admin-article-create-manufacturer')}
                    ...
                    <div className={styles.articleFooterNav}>
                        <button className={styles.footerNavBtn} onClick={() => navigate('/knowledge-base/admin-article-create-manufacturer')}>
                            <svg width="14" height="14" viewBox="0 0 24 24" fill="none">
                                <path d="M19 12H5M5 12l7 7M5 12l7-7" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                            </svg>
                            Previous: Create a Manufacturer
                        </button>
                        <button className={styles.footerNavBtnNext} onClick={() => navigate('/knowledge-base/manuals-admin')}>
                            Back to Admin Manuals
                            <svg width="14" height="14" viewBox="0 0 24 24" fill="none">
