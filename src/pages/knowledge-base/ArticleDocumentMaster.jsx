    ...
    return (
        <div className={styles.page}>
            <header className={styles.topBar}>
                <button className={styles.backBtn} onClick={() => navigate('/knowledge-base/manuals-manufacturer')}>
            ...
            <div className={styles.layout}>
                ...
                <article className={styles.article}>
                    <div className={styles.breadcrumb}>
                        <button className={styles.breadLink} onClick={() => navigate('/knowledge-base/manuals-pcf')}>Manuals</button>
                        <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="#d1d5db" strokeWidth="2.5">
                            <polyline points="9 18 15 12 9 6" />
                        </svg>
                        <button className={styles.breadLink} onClick={() => navigate('/knowledge-base/manuals-manufacturer')}>Manufacturer</button>
                        <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="#d1d5db" strokeWidth="2.5">
                            <polyline points="9 18 15 12 9 6" />
                        </svg>
                    ...
                    <div className={styles.articleFooterNav}>
                        <button className={styles.footerNavBtn} onClick={() => navigate('/knowledge-base/article-component-master')}>
                            <svg width="14" height="14" viewBox="0 0 24 24" fill="none">
                                <path d="M19 12H5M5 12l7 7M5 12l7-7" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                            </svg>
                            Previous: Component Master
                        </button>
                        <button className={styles.footerNavBtnNext} onClick={() => navigate('/knowledge-base/manuals-manufacturer')}>
                            Back to Manuals
                            <svg width="14" height="14" viewBox="0 0 24 24" fill="none">
