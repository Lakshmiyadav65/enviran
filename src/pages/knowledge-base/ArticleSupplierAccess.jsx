    ...
    return (
        <div className={styles.page}>
            <header className={styles.topBar}>
                <button className={styles.backBtn} onClick={() => navigate('/knowledge-base/manuals-supplier')}>
            ...
            <div className={styles.layout}>
                ...
                <article className={styles.article}>
                    <div className={styles.breadcrumb}>
                        ...
                        <button className={styles.breadLink} onClick={() => navigate('/knowledge-base/manuals-supplier')}>Supplier</button>
                        <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="#d1d5db" strokeWidth="2.5">
                            <polyline points="9 18 15 12 9 6" />
                        </svg>
